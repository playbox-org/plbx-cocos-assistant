...
export const LOCALES: Record<Lang, LocaleDict> = {
  en: {
    ...
    'settings.encBase64': 'base64',
    'settings.encBase122': 'base122 (~14% smaller)',
    'settings.encBoth': 'both (A/B compare)',
    'settings.encHint': 'base122 ~14% smaller on disk. "both" emits index.html (base122) + index.b64.html.',
  ...
  ru: {
    ...
    'settings.encHint': 'base122 на ~14% меньше на диске. «обе» отдаёт index.html (base122) + index.b64.html.',
  ...
  zh: {
    ...
    'settings.encHint': 'base122 磁盘体积小约 14%。"两者"会输出 index.html（base122）+ index.b64.html。',
